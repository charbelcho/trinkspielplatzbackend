...
<div class="container">
	<div class="row mt-5 anleitung">
		<div class="card-body">
			<form action="/addEher" method="post">
			<div class="form-group">
				<label>Wer würde eher...</label>
				<textarea name="vorschlagEher" placeholder="eine Frage hinzufügen" class="form-control" rows="3" required></textarea>
			</div>
    ...
    <div class="row pt-5">
	    ...
	    <table class="table">
			...
			<c:forEach items="${alleEher}" var="eher">
		    	<tr>
		    		<td>${eher.id}</td>
		    		<td>${eher.eher}</td>
		    	</tr>
